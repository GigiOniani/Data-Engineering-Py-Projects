...
def transform_friends_data():
    friends = pd.read_csv('C:\\Users\\User\\PycharmProjects\\Exercising\\Assignment1\\data\\friends_table.csv')
    posts = pd.read_csv(f'C:\\Users\\User\\PycharmProjects\\Exercising\\Assignment1\\data\\posts_table.csv')
    reactions = pd.read_csv(f'C:\\Users\\User\\PycharmProjects\\Exercising\\Assignment1\\data\\reactions_table.csv')
    users = pd.read_csv(f'C:\\Users\\User\\PycharmProjects\\Exercising\\Assignment1\\data\\user_table.csv')
    ...
    return friends_table_finalized

def generate_friends_data(output_path):
    friends_table_finalized = transform_friends_data()
